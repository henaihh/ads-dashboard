...
export const SAMPLE_CAMPAIGNS: Campaign[] = [
  {
    ...
    demographics: {
      ...
      region: {
        ...
        conversions: [
          { label: 'Córdoba', value: 55 },
          { label: 'Buenos Aires', value: 42 },
          { label: 'CABA', value: 28 },
          { label: 'Otras', value: 18 },
          { label: 'Santa Fe', value: 12 },
          { label: 'Mendoza', value: 7 },
          { label: 'Tucumán', value: 3 },
  ...
  },
  {
    ...
    demographics: {
      ...
      region: {
        ...
        conversions: [
          { label: 'CABA', value: 98 },
          { label: 'Buenos Aires', value: 76 },
          { label: 'Córdoba', value: 32 },
          { label: 'Santa Fe', value: 18 },
